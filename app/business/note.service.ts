...
export class NoteService {
    ...
    getNotes() {
        ...
        let url = "http://" + this.config.server + "/restapi/2.0/thread/?expand=thread;entry;entities;entity;source;submitter;&outputformat=json&page=1&rpp=200&showpermission=true&sortby=lastediteddate&sortorder=desc";
